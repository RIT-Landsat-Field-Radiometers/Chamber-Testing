...
NAME
	EC_controller.py: This script is used to control the TC180 controller via the Watlow F4T controller. 
...
NAME
	EC_controller_gui.py: This script launches a GUI that allows the user to monitor the chamber, run profiles, and run custom-made programs (WIP)
